...
| 15 | host variables | SOPORTADO | Extraídas del propio texto `EXEC SQL` vía el patrón `:IDENTIFICADOR`. | `comprehensive.cbl` | `sql/EmbeddedSqlExtractorTest.selectWithHostVariablesAndPredicate` | Los host variables provienen del SQL real extraído, nunca de una lista fabricada en el test. |
